...
INSERT INTO "annonce" (titre, idUtilisateur, datePublication, duree, description, photo, lieu) VALUES ('Catan','1','2021-04-24', 2, 'Jeu de société très sympa, je ne le prête que pour une soirée ou un week-end.', TRUE, '1 Rue de la Résistance, Évry-Courcouronnes, France');
INSERT INTO "annonce" (titre, idUtilisateur, datePublication, duree, description, photo, lieu) VALUES ('Livres informatique','2','2021-04-30', NULL, 'Idéal pour réaliser un site web comme ENTRAiiDe.', TRUE, 'Boulevard de l Europe, Évry-Courcouronnes, France');
INSERT INTO "annonce" (titre, idUtilisateur, datePublication, duree, description, photo, lieu) VALUES ('Le JavaScript pour les nuls','3','2021-05-02', 30, 'Ayant fini mon projet web, je prête ce livre avec grand plaisir !', TRUE, '2 Villa Charles Delescluze, Évry-Courcouronnes, France');
INSERT INTO "annonce" (titre, idUtilisateur, datePublication, duree, description, photo, lieu) VALUES ('Intégrale de How I met your mother','4','2021-05-01', 15, 'Très bonne série que je prête avec grand plaisir', TRUE, 'Cours Monseigneur Roméro, Évry-Courcouronnes, France');
INSERT INTO "annonce" (titre, idUtilisateur, datePublication, duree, description, photo, lieu) VALUES ('Trilogie du Seigneur des Anneaux','1','2021-05-04', NULL, '', TRUE, '1 Rue de la Résistance, Évry-Courcouronnes, France');
